...
<LINK href="${ctx }/css/envirMonitor/title.css" type="text/css" rel="stylesheet">
...
<div class="title">
     <div class="top">
          <a href="javascript:exit();"><img src="${ctx }/images/envirMonitor/tcxt.png"/></a>
     </div>
     <div class="dqyh">当前用户：${user.realname } <span id="date">2014年09月13日</span></div>
      <div class="nav" id="nav">
          <span class="nav-btn-xz"><a href="${ctx }/admin/envirMonitor/dispense" target="mainFrame">实时监控</a></span>
          <span><img src="${ctx }/images/envirMonitor/fg.gif"/></span>
          <span class="nav-btn-fxz"><a href="${ctx }/admin/envirMonitor/dataCollect" target="mainFrame">数据汇总</a></span>
          <span><img src="${ctx }/images/envirMonitor/fg.gif"/></span>
          <span class="nav-btn-fxz"><a href="${ctx }/admin/envirMonitor/charts" target="mainFrame">曲线分析</a></span>
          <span><img src="${ctx }/images/envirMonitor/fg.gif"/></span>
          <span class="nav-btn-fxz"><a href="${ctx }/admin/envirMonitor/dataQuery" target="mainFrame">数据查询</a></span>
          <span><img src="${ctx }/images/envirMonitor/fg.gif"/></span>
		  <!--
