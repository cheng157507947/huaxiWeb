...
<frameset rows="96,*,35" cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="${ctx }/admin/envirMonitor/top" name="topFrame" scrolling="no" noresize="noresize" id="topFrame" border="0" />
  <frameset rows="*" cols="200,*" frameborder="no" border="0" framespacing="0"  scrolling="auto">
     <frame src="${ctx }/admin/envirMonitor/left" name="leftFrame" scrolling="auto" noresize="noresize" id="leftFrame" border="0" />
