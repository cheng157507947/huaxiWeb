...
function GetLoginInfoFunc(parameter){
	if(parameter == 1){
		var a = IP_CAM.PlayRealVideo(nowGuid);
	}
}
</script>
</head>
...
<div class="main-right">
     <div class="ssjk">
          <div class="bk-bt-xxk">
               ...
               <div class="bjzt">DTU设备状态：<span id="online">在线 <img src="${ctx }/images/irrigateContorl/online-green.gif"/></span> <span id="commTime">2015-04-26 23:40</span></div>
          </div>
          ...
          <ul class="qxzbul">
               <li id="fieldData1">
                    <div class="flash">
					<img src="${ctx }/images/irrigateContorl/icon-bg.png"/>
                    <div class="cssz">26米</div>
					</div>
                    <div class="qxzb"><img src="${ctx }/images/irrigateContorl/qx-icon1.gif"/></div>
               ...
               <li id="fieldData5">
                    ...
                    <div class="qxzb"><img src="${ctx }/images/irrigateContorl/qx-icon2.gif"/></div>
               ...
               <li id="fieldData6">
                    ...
                    <div class="qxzb"><img src="${ctx }/images/irrigateContorl/qx-icon3.gif"/></div>
              ...
              <li id="fieldData7">
                    ...
                    <div class="qxzb"><img src="${ctx }/images/irrigateContorl/qx-icon4.gif"/></div>
