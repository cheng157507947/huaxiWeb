...
$(document).ready(function(){
	...
	window.parent.frames['mainFrame'].location = "${ctx }/admin/sourceMonitor/dispense";
});
</script>
<style type="text/css">
...
<div class="left" id="left">
	<div id="mian">
		 <div class="zkgbc">
			  <a onFocus="blur()" onclick="zTree.expandAll(true);"><img src="${ctx }/images/sourceMonitor/zk-btn.gif"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
			  <a onFocus="blur()" onclick="closeAll();"><img src="${ctx }/images/sourceMonitor/gb-btn.gif"/></a>
		 </div>
